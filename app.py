...
app = Flask(__name__) # to create the application instance
moment = Moment(app) # to use the moment extension
app.config.from_object("config") # to load the config from the config.py file
db = SQLAlchemy(app) # to initialize the database object

migrate = Migrate(app, db) # to initialize the migration object
